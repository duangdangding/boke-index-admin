...
public class SysNoticeServiceImpl implements ISysNoticeService {
     ...
     */
    @Override
    public IPage<SysNotice> selectSysNoticePage(SysNotice sysNotice, PageDomain pageDomain) {
        Page<SysNotice> page = new Page<>(pageDomain.getPage(), pageDomain.getLimit());
        return sysNoticeMapper.selectSysNoticeList(page,sysNotice);
    }
/*
    @Override
