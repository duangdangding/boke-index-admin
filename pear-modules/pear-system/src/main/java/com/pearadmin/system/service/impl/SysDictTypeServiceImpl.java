...
public class SysDictTypeServiceImpl implements ISysDictTypeService {
     ...
     */
    @Override
    public IPage<SysDictType> page(SysDictType sysDictType, PageDomain pageDomain) {
        Page<SysDictType> page = new Page<>(pageDomain.getPage(), pageDomain.getLimit());
        return sysDictTypeMapper.selectList(page,sysDictType);
    }
/*
    @Override
