...
public class SysRoleServiceImpl implements ISysRoleService {
     ...
     */
    @Override
    public IPage<SysRole> page(SysRole param, PageDomain pageDomain) {
        Page<SysRole> page = new Page<>(pageDomain.getPage(), pageDomain.getLimit());
        return sysRoleMapper.selectList(page,param);
    }
/*
    @Override
