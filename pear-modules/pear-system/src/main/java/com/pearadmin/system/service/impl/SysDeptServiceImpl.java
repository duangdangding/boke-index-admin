...
public class SysDeptServiceImpl implements ISysDeptService {
     ...
     */
    @Override
    public IPage<SysDept> page(SysDept param, PageDomain pageDomain) {
        Page<SysDept> page = new Page<>(pageDomain.getPage(), pageDomain.getLimit());
        return sysDeptMapper.selectList(page,param);
    }
/*
    @Override
