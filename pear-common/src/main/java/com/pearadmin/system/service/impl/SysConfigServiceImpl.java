...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    @Override
    public IPage<SysConfig> page(SysConfig param, PageDomain pageDomain) {
        Page<SysConfig> page = new Page<>(pageDomain.getPage(), pageDomain.getLimit());
        return sysConfigMapper.selectList(page,param);
    }
